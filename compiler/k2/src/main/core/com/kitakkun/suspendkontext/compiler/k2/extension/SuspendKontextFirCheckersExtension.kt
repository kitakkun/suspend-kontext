...
import com.kitakkun.suspendkontext.compiler.k2.checkers.MultipleContextApplicationChecker
...
class SuspendKontextFirCheckersExtension(session: FirSession) : FirAdditionalCheckersExtension(session) {
    override val declarationCheckers: DeclarationCheckers = object : DeclarationCheckers() {
        override val functionCheckers: Set<FirFunctionChecker> = setOf(AnnotationUseSiteChecker, MultipleContextApplicationChecker)
    }
